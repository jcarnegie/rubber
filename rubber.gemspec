...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "generators/vulcanize/templates/node/config/rubber/deploy-node.rb",
    "generators/vulcanize/templates/node/config/rubber/rubber-node.yml",
    "generators/vulcanize/templates/node/INSTALL_NOTES",
